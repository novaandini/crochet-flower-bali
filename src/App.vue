<template>
  <div class="bg-white">
    <header class="inset-x-0 top-0 z-50 fixed bg-white">
      <nav class="flex items-center justify-between px-6 py-2 lg:px-8" aria-label="Global">
    ...
    <div class="relative isolate px-6 pt-14 lg:px-8 md:pt-20">
